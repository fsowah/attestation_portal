    ...
    <header className="relative z-30 text-white flex flex-col shrink-0 shadow-sm" style={{ background: 'linear-gradient(270deg, #0C4FA5 0%, #0D1F36 100%)' }}>
      <div className="flex justify-between items-center h-20 px-6">
        ...
        <div className="flex items-center gap-3">
          <img src={LogoCrest} alt="MoFA Logo" className="h-12 w-auto" />
          <div className="flex flex-col">
            <h2 className="font-bold text-[15px] leading-tight">Ministry of Foreign Affairs</h2>
            <p className="text-brand-gold-500 font-medium text-[11px] tracking-wide">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-3 bg-white/10 rounded-full py-1.5 px-2 border border-white/20 cursor-pointer hover:bg-white/20 transition-colors">
            ...
            <div className="flex flex-col pr-1">
              <span className="text-[13px] font-semibold leading-tight">Serwaa Mensah</span>
              <span className="text-[10px] text-gray-300 leading-tight">System Administrator</span>
            </div>
            <ChevronDown className="w-4 h-4 text-gray-300 mr-1" />
          </div>
        </div>
      </div>
