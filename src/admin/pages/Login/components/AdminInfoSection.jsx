...
const AdminInfoSection = () => {
  const stats = [
    { label: 'Total Today', value: '1,284', iconBg: 'bg-transparent' },
    { label: 'Pending Review', value: '47', iconBg: 'bg-yellow-100' },
    { label: 'Active Staff', value: '27', iconBg: 'bg-green-100' },
    { label: 'Open Tickets', value: '7', iconBg: 'bg-red-100' }
  ];
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <div className="mb-10">
          <h1 className="text-white text-[42px] xl:text-[56px] font-bold leading-[1.1] mb-6 tracking-tight">
            System Administration<br />Portal
          </h1>
          <p className="text-[#a1b0c0] text-[15px] xl:text-[17px] max-w-lg font-medium leading-relaxed">
            For authorised System Administrators only. Access is governed by your<br />government Active Directory credentials.
          </p>
        </div>
